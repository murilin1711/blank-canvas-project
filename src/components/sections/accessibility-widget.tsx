    ...
    <div id="vlibras" className="enabled fixed bottom-5 left-5 z-40">
      ...
      >
        <Image
          ...
          src="https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/test-clones/b560228b-ad03-4100-8449-603f81169220-osklen-com-br/assets/svgs/access_icon-1.svg"
          alt=""
          width={32}
          height={32}
        />
