...
const HeroBanner = () => {
  ...
  return (
    <section className="relative w-full min-h-[calc(100vh-80px)] md:min-h-[calc(100vh-100px)] flex items-center justify-center overflow-hidden">
      ...
      {/* Slides Container - Ajustado para ser menor no desktop */}
      <div
        id="hero-banner"
        className="relative z-10 flex items-center justify-center p-4 md:p-6 lg:p-8 !w-full !h-full"
        onTouchStart={handleTouchStart}
        onTouchMove={handleTouchMove}
        onTouchEnd={handleTouchEnd}>

        <div className="relative w-full max-w-full md:max-w-[85%] lg:max-w-[75%] overflow-hidden rounded-xl lg:rounded-3xl shadow-lg lg:shadow-[0_8px_30px_rgba(0,0,0,0.12)] transition-shadow duration-300 aspect-video">
