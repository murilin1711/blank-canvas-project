...
const HeroBanner = () => {
  ...
  return (
    <section className="relative h-screen overflow-hidden !w-full lg:!h-[651px]">
      ...
      <div
        id="hero-banner"
        className="relative z-10 flex items-center justify-center p-4 md:p-6 lg:p-8 lg:pt-0 !w-full !h-[557px]"
