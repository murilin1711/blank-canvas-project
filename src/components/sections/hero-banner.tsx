...
const HeroBanner = () => {
  ...
  return (
    <section className="relative w-full pt-[80px] md:pt-[100px] min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div
          ...
          index === currentSlide ? 'opacity-100' : 'opacity-0 pointer-events-none'}`
            ...
            aria-hidden="true">
              ...
              <div className="absolute inset-0 bg-black/20 !w-full !h-[506px]" aria-hidden="true" />
            </div> :
        null
        )}
      </div>
      ...
      <div
        id="hero-banner"
        className="relative z-10 flex items-center justify-center p-4 md:p-6 lg:p-8 !w-full !h-[277px]">
